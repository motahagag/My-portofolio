...
const socialLinks = [
  ...
  {
    href: 'https://www.instagram.com/mohamedtahahagag/?hl=en',
  ...
  return (
    <section id='contact' className='section'>
        <div className='container lg:grid lg:grid-cols-2 lg:items-stretch'>
            ...
            <form action='https://getform.io/f/avrmlvea' method='POST' className='xl:pl-10 2xl:pl-20'>
                    <div className='md:grid md:items-center md:grid-cols-2 md:gap-2'>
                        <div className='mb-4'>
                            <label htmlFor='name' className='label'>
                                Name
                            </label>
                         <input type='text' name='name' id='name' autoComplete='name' required placeholder='mohamed Taha' className='text-field reveal-up' />
                        </div>
                        ...
                        <div className='mb-4'>
                         ...
                         <input type='email' name='email' id='email' autoComplete='email' required placeholder='mohamed.taha@example.com' className='text-field reveal-up' />
                        </div>
                    </div>
